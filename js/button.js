define(['react', 'react-dom'], function(React, ReactDOM) {
	...
	var initRandomizeChartButton = function(chart, buttonId) {
		...
		const domContainer = document.querySelector(buttonId);
		ReactDOM.render(e(RandomizeButton), domContainer);
	}

	return {
		initRandomizeChartButton: initRandomizeChartButton,
	};
});
